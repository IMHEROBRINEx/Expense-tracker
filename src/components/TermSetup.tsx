...
export function TermSetup({ onStart, onCancel, isInitial = false, activeCurrencySymbol = '$' }: TermSetupProps) {
    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-1 relative">
            {/* Soft background glow for the setup card */}
            <div className="absolute inset-x-0 -top-10 -bottom-10 bg-primary/5 blur-3xl -z-10 rounded-full"></div>

            <div className="glass-card overflow-hidden">
                <div className="bg-surface px-6 py-8 text-center border-b border-white/5 relative z-10">
